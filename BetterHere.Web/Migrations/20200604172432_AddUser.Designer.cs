...
namespace BetterHere.Web.Migrations
{
    ...
    [Migration("20200604172432_AddUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.CityEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.EstablishmentEntity", b =>
                {
                    ...
                    b.Property<string>("LogoEstablishmentPath");
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.EstablishmentLocationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.FoodEntity", b =>
                {
                    ...
                    b.Property<string>("EstablishmentLocationId");

                    b.Property<int?>("EstablishmentLocationsId");

                    b.Property<string>("FoodName");

                    b.Property<string>("PicturePathFood");

                    b.Property<float>("Qualification");

                    b.Property<string>("Remarks");

                    b.Property<int?>("TypeFoodsId");
                    ...
                    b.HasIndex("FoodName", "EstablishmentLocationId")
                        .IsUnique()
                        .HasFilter("[FoodName] IS NOT NULL AND [EstablishmentLocationId] IS NOT NULL");

                    b.ToTable("Foods");
                });

            modelBuilder.Entity("BetterHere.Web.Data.Entities.TypeEstablishmentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<string>("PicturePathUser");
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.EstablishmentLocationEntity", b =>
                {
                    b.HasOne("BetterHere.Web.Data.Entities.CityEntity", "Cities")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BetterHere.Web.Data.Entities.UserEntity")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
