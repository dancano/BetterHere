        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PicturePathUser = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeEstablishments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoEstablishmentPath = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    TypeEstablishmentId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TypeEstablishmentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstablishmentsId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstablishmentLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EstablishmentLocations_Establishments_EstablishmentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PicturePathFood = table.Column<string>(nullable: true),
                    Qualification = table.Column<float>(nullable: false),
                    Remarks = table.Column<string>(nullable: true),
                    TypeFoodsId = table.Column<int>(nullable: true),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Foods_TypeFoods_TypeFoodsId",
                        column: x => x.TypeFoodsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstablishmentLocations_EstablishmentsId",
