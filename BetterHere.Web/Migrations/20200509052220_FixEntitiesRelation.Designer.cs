...
namespace BetterHere.Web.Migrations
{
    ...
    [Migration("20200509052220_FixEntitiesRelation")]
    partial class FixEntitiesRelation
    {
            ...
            modelBuilder.Entity("BetterHere.Web.Data.Entities.FoodEntity", b =>
                {
                    ...
                    b.HasIndex("FoodName", "EstablishmentId")
                        .IsUnique()
                        .HasFilter("[FoodName] IS NOT NULL AND [EstablishmentId] IS NOT NULL");
